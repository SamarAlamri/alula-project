...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !empty($token)) {
    ...
    if (empty($new_password) || empty($confirm_password)) {
        ...
        $password_error = "Password must be at least 8 characters and include uppercase, lowercase, numbers, and special characters.";
    } else {
    ...
    <form action="reset_password.php" method="POST">
        ...
        <p>
            ...
            <?php if (!empty($password_error)) { ?>
                <span class="password-error"><?php echo $password_error; ?></span>
            <?php } ?>
        </p>
